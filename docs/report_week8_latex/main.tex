...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/1_Daily_customer_demand_outcomes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/comparison_prices_over_time.png}
\caption{Printer prices: holiday-rush vs calm-market}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/comparison_inventory_over_time.png}
\caption{Retailer \& manufacturer inventory: holiday-rush vs calm-market}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/comparison_order_fulfillment.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth, height=0.85\textheight, keepaspectratio]{images/grafico.png}
