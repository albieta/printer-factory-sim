...
class ConfigService:
    ...
    def serialize_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "retailer_demand_enabled": config.retailer_demand_enabled,
            "retailer_demand_mean": config.retailer_demand_mean,
            "retailer_demand_variance": config.retailer_demand_variance,
            "retailer_demand_modifier": config.retailer_demand_modifier,
            "retailer_demand_base_price": config.retailer_demand_base_price,
